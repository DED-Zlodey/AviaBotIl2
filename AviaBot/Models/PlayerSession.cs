...
namespace AviaBot.Models
{
    ...
    {
        /// <summary>Событие (spawn, position, despawn и т.д.)</summary>
        ...
        /// <summary>ID родительского объекта (PID)</summary>
        [JsonPropertyName("pid")]
        public int Pid { get; set; } = -1;

        /// <summary>Код страны/коалиции</summary>
        ...
        /// <summary>Название объекта (самолёт, техника)</summary>
        [JsonPropertyName("name")]
        public string ObjectName { get; set; } = string.Empty;

        /// <summary>Тип объекта (aircraft, vehicle и т.д.)</summary>
        ...
        /// <summary>Координата Z (высота)</summary>
        [JsonPropertyName("z")]
        ...
        /// <summary>Локализация/регион</summary>
